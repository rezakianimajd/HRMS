  ...
  return (
    <Box>
      <Paper sx={{ ...glassPaper, p: 2 }}>
        ...
        <Stack spacing={0.75}>
          {itemList.map(it => (
            <Paper key={it.id} variant="outlined" sx={{ p: 1, borderRadius: 10, display: 'flex', alignItems: 'center', gap: 1 }}>
...
const ContractWBSManager = () => {
  ...
  return (
    <Paper sx={{ ...glassPaper, p: 2 }}>
      ...
      <Stack spacing={0.75}>
        {linkList.map(l => (
          <Paper key={l.id} variant="outlined" sx={{ p: 1, borderRadius: 10, display: 'flex', alignItems: 'center', gap: 1 }}>
...
const ContractPriceBasisManager = () => {
  ...
  return (
    <Paper sx={{ ...glassPaper, p: 2 }}>
      ...
      <Stack spacing={0.75}>
        {baseList.map(b => (
          <Paper key={b.id} variant="outlined" sx={{ p: 1, borderRadius: 10, display: 'flex', alignItems: 'center', gap: 1 }}>
