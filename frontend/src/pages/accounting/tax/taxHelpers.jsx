...
export const COLOR = '#d97706';
export const COLOR_DARK = '#b45309';
...
export const glass = {
  ...
  boxShadow: '0 14px 40px rgba(217,119,6,0.12)',
  borderRadius: '16px',
};
...
export default { COLOR, COLOR_DARK, BLUE, GREEN, RED, glass, ReportHeader, Loading, StatCard };