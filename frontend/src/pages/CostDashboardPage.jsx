  ...
  return (
    <Box>
      <Paper sx={{ p: 2.5, mb: 2.5, display: 'flex', alignItems: 'center', gap: 2, flexWrap: 'wrap',
        ...
        border: '1px solid rgba(16,185,129,0.18)', borderRadius: 10 }}>
...
const CostTransactionsManager = ({ projectId }) => {
  ...
  return (
    <Paper sx={{ ...glassPaper, p: 2 }}>
      ...
      <Stack spacing={0.75}>
        {list.map(t => (
          <Paper key={t.id} variant="outlined" sx={{ p: 1, borderRadius: 10 }}>
...
const BudgetManager = ({ projectId }) => {
  ...
  return (
    <Paper sx={{ ...glassPaper, p: 2 }}>
      ...
      <Stack spacing={0.75}>
        {list.map(b => (
          <Paper key={b.id} variant="outlined" sx={{ p: 1, borderRadius: 10 }}>
...
const CommittedManager = ({ projectId }) => {
  ...
  return (
    <Paper sx={{ ...glassPaper, p: 2 }}>
      ...
      <Stack spacing={0.75}>
        {list.map(c => (
          <Paper key={c.id} variant="outlined" sx={{ p: 1, borderRadius: 10 }}>
...
const ProgressManager = ({ projectId }) => {
  ...
  return (
    <Paper sx={{ ...glassPaper, p: 2 }}>
      ...
      <Stack spacing={0.75}>
        {list.map(s => (
          <Paper key={s.id} variant="outlined" sx={{ p: 1, borderRadius: 10 }}>
