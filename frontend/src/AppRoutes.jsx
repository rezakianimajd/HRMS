...
import OpeningDocumentPage from './pages/accounting/annual/OpeningDocumentPage';
...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="/accounting/document-new" element={<ProtectedLayout><AccountingDocumentNewPage /></ProtectedLayout>} />
      <Route path="/accounting/documents/new" element={<Navigate to="/accounting/document-new" replace />} />
      ...
      <Route path="/accounting/annual/opening-document" element={<ProtectedLayout><OpeningDocumentPage /></ProtectedLayout>} />
