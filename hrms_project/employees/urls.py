...
from employees import employee_summary_views
...
urlpatterns = [
    ...
    # Employee summary (profile overview)
    path('employees/<int:employee_id>/summary/', employee_summary_views.employee_summary),
