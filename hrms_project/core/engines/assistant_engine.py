...
# ---------------------------------------------------------------------------
FIELD_SYNONYMS = {
    'hire_date':      ['استخدام', 'شروع به کار', 'تاریخ ورود', 'ورود به شرکت', 'کی اومد', 'کی استخدام'],
    'address':        ['آدرس', 'نشانی', 'محل سکونت', 'کجا زندگی', 'کجاست خونه'],
    'mobile':         ['موبایل', 'تلفن', 'شماره تماس', 'شماره موبایل', 'تماس'],
    'birth_date':     ['تولد', 'متولد', 'تاریخ تولد'],
    'department':     ['دپارتمان', 'بخش', 'واحد', 'کدوم دپارتمان'],
    'job_title':      ['عنوان شغلی', 'سمت', 'شغل', 'پست'],
    'contract':       ['قرارداد', 'پایان قرارداد', 'نوع قرارداد', 'انقضا'],
    'benefit':        ['مزایای رفاهی', 'مزایا', 'کارانه', 'عیدی', 'بن کار', 'بن ', 'وام', 'هدیه', 'کمک هزینه', 'رفاهی', 'پاداش', 'سبد', 'مناسبت'],
    'payroll':        ['حقوق', 'دریافت', 'پرداخت', 'فیش', 'کسور', 'خالص', 'دریافتی'],
    'work_days':      ['کارکرد', 'روز کار', 'کار کرده', 'چند روز کار'],
    'documents':      ['مدرک', 'سند', 'مدارک', 'مدرکش'],
    'national_id':     ['کد ملی', 'شماره ملی'],
    'employee_id':     ['کد پرسنلی', 'شماره پرسنلی'],
    'gender':          ['جنسیت', 'مرد', 'زن'],
    'marital_status':  ['تاهل', 'مجرد', 'متاهل'],
    'children':        ['فرزند', 'بچه'],
    'age':             ['سن', 'چند سالش'],
    'education':       ['تحصیلات', 'مدرک تحصیلی', 'رشته', 'لیسانس', 'فوق لیسانس', 'دکتری', 'دیپلم', 'کاردانی', 'کارشناسی'],
    'city':            ['شهر', 'اهل کجا', 'ساکن کجا', 'کدوم شهر'],
    'distance':        ['مسافت', 'فاصله', 'راه تا محل کار', 'کیلومتر تا محل کار'],
    'performance':     ['عملکرد', 'پرفورمنس', 'نمره ارزیابی', 'نمره عملکرد'],
    'satisfaction':    ['رضایت', 'رضایت شغلی', 'نمره رضایت'],
    'work_experience': ['سابقه کار', 'سابقه کاری', 'سوابق کاری', 'سابقه قبل از استخدام'],
    'work_hours':      ['ساعت کاری', 'ساعت شروع', 'ساعت پایان', 'ساعت ورود', 'ساعت خروج', 'شیفت کاری'],
    'score':           ['امتیاز', 'نمره کل', 'ارزیابی کلی', 'امتیازدهی', 'رتبه'],
    'leave':           ['مرخصی', 'مانده مرخصی', 'مصرفی مرخصی', 'مرخصی استحقاقی', 'مرخصی استعلاجی', 'چند روز مرخصی'],
    'penalty':         ['جریمه', 'جرائم', 'کسری', 'توبیخ', 'دیرکرد جریمه'],
}

# general intents (no specific employee)
GENERAL_INTENTS = [
    ('total_employees',  ['چند پرسنل', 'تعداد پرسنل', 'چند نفر پرسنل', 'تعداد کارمند', 'چند کارمند']),
    ('turnover',         ['نرخ خروج', 'ترک خدمت', 'اخراج', 'بازنشستگی', 'نرخ ترک']),
    ('birthdays',        ['تولد ۷ روز', 'تولد هفت روز', 'تولدهای آینده', 'تولد این هفته']),
    ('contracts',        ['قرارداد در شرف', 'قراردادهای در حال', 'پایان قراردادها']),
    ('documents_total',  ['چند مدرک', 'تعداد مدارک']),
    ('resignation_risk', ['احتمال استعفا', 'ریسک خروج', 'ریسک استعفا', 'احتمال خروج', 'چه کسانی ممکن است استعفا']),
    ('correspondences',  ['مکاتبات', 'نامه وارده', 'نامه صادره', 'ابلاغ', 'فرم']),
    ('salary_total',     ['جمع حقوق', 'مجموع حقوق', 'کل حقوق', 'مجموع پرداخت']),
    ('greeting',         ['سلام', 'درود', 'هی', 'خوبی']),
    ('thanks',           ['ممنون', 'تشکر', 'مرسی', 'سپاس']),
    ('scoring',          ['امتیاز کارکنان', 'رتبه بندی کارکنان', 'بهترین کارمند', 'برترین کارمند', 'ارزیابی کارکنان', 'امتیازدهی کارکنان']),
    ('chart',            ['نمودار', 'چارت', 'دیاگرام', 'نمودار پرسنل', 'نمودار دپارتمان', 'نمودار جنسیت', 'نمودار عنوان', 'نمودار محل']),
]
