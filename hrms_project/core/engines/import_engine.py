...
PERSIAN_FIELD_LABELS = {
    ...
    'education_place': 'محل اخذ مدرک تحصیلی',
    'bank_name': 'بانک',
        ...
        for row in rows:
            ...
            try:
                Employee.objects.create(
                    ...
                    birth_certificate_number=str(row.get('birth_certificate_number', '')).strip() or None,
                    mobile=mobile or '',
                    ...
                    insurance_number=str(row.get('insurance_number', '')).strip() or None,
